...
Run `pnpm dev:web` from the repository root. In another terminal, run `npm ci --prefix apps/mobile`, `npm run typecheck --prefix apps/mobile`, and `npm start --prefix apps/mobile`.
