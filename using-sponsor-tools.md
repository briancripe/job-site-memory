...
Use Node.js 22+. For Slack/web/mobile, follow the chosen [template's setup instructions](README.md#templates) and keep credentials in root `.env`. Never put keys in frontend code or a submission. `pnpm verify` covers offline behavior, not live account access.
